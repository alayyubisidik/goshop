<div class="accordion-item mb-3 cursor-pointer">
    <div class="accordion-header">
        <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#variant-{{ $variant->id }}"
            aria-expanded="false">
                    ...
                    <div class="col-md-12 mb-3">
                        <label class="form-check mt-3">
                            <input class="form-check-input variant-manage-stock" type="checkbox"
                                name="variant_manage_stock" value="1" @checked($variant->manage_stock == 1)>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex gap-2">
                                    <label class="form-check">
                                        <input class="form-check-input" checked type="radio" name="variant_stock_status"
                                            value="in_stock" @checked($variant->in_stock == 1)>
                                        <span class="form-check-label">In Stock</span>
                                    </label>
                                    <label class="form-check">
                                        <input class="form-check-input" type="radio" name="variant_stock_status"
                                            value="out_of_stock" @checked($variant->in_stock == 0)>
