                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="text-secondary">Total Pending Order</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{ $pendingOrders }} Pending</div>
                                        <div class="text-secondary">Total Pending Order</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{ $completedOrders }} Completed</div>
                                        <div class="text-secondary">Total Completed Order</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{ $canceledOrders }} Canceled</div>
                                        <div class="text-secondary">Total Canceled Order</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{ $totalProducts }} Products</div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{ $totalDigitalProducts }} Digital Products</div>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div class="font-weight-medium">{{ $totalPhysicalProducts }} Physical Products
                                        </div>
