                    ...
                    <div class="row mt-10">
                        <div class="col-6 col-md-4 col-lg-6 col-xl-3 wow fadeInUp">
                            <a href="{{ route("paypal.payment") }}" class="wsus__payment_method">
                                <img src="{{ asset("assets/frontend/dist/imgs/payment_4.png") }}" alt="payment" class="img-fluid w-100">
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-lg-6 col-xl-3 wow fadeInUp">
                            <a href="{{ route("stripe.payment") }}" class="wsus__payment_method">
                                <img src="{{ asset("assets/frontend/dist/imgs/payment_1.png") }}" alt="payment" class="img-fluid w-100">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="wsus__billing_summary">
                                ...
                                @foreach ($cartItems['items'] as $cartItem)
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            ...
                                            <h6 style="color: #ff9010">${{ $price['price'] }} x {{ $cartItem->quantity }}
                                            </h6>
                                        </div>
                                    </li>
                                @endforeach
                        ...
                        <div class="wsus__total_price">
                            ...
                            <p>Shipping Charge <span>$ <span class="shipping_charge">{{ $shippingCharge }}</span></span></p>
                            <p>Discount <span>$ {{ $cartDiscount }}</span></p>
                        </div>

                        <h5> Total <span>$ <span class="grand_total">{{ ($cartSubTotal + $shippingCharge) - $cartDiscount }}</span></span>
                        </h5>
