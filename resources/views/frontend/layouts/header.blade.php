        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="/"><img src="{{ asset('assets/backend/dist/img/logo/logo.png') }}" alt="logo" /></a>
                </div>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#" onclick="event.preventDefault(); document.querySelector('.logout-form').submit();"><i class="fi fi-rs-sign-out mr-10"></i>Sign
                                                out</a>
                                        </li>
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="index.html"><img src="{{ asset('assets/backend/dist/img/logo/logo.png') }}" alt="logo" /></a>
                </div>
