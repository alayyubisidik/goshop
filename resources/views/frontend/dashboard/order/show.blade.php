        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="page-wrapper">
                    <!-- BEGIN PAGE HEADER -->
                    <div class="page-header d-print-none my-3" aria-label="Page header">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12 my-5">
                                            <p style="font-size: 20px; font-weight: bold; color: black;">Invoice #{{ $order->id }}</p>
                                            ...
                                            @foreach ($order->orderProducts as $orderProduct)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <d iv class="text-secondary">
                                                            {{ $orderProduct->variant['name'] ?? '' }}</d>
                                                    </td>
                                                    <td class="text-center">{{ $orderProduct->quantity }}</td>
                                                    <td class="text-end">
                                                        {{ $orderProduct->unit_price }}</td>
                                                    <td class="text-end">
