        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-actions">
                    <a href="{{ route('vendor.withdraw-requests.create') }}" class="btn btn-primary">Create</a>
                </div>
            </div>
                        ...
                        <tbody>
                            @forelse ($withdrawRequests as $withdrawRequest)
                                <tr>
                                    ...
                                    <td>
                                        @if ($withdrawRequest->status == 'pending')
                                            <form action="{{ route('vendor.withdraw-requests.destroy', $withdrawRequest) }}" method="POST">
                                                @csrf
                                                @method('delete')
