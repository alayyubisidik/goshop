    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item  {{ setActive(['admin.newsletters.*']) }}">
                ...
                <li class="nav-item {{ setActive(['admin.advertisement-banner.*']) }}">
                    <a class="nav-link" href="{{ route('admin.advertisement-banner.one.index') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <li class="nav-item {{ setActive(['admin.shipping-rules.*']) }}">
